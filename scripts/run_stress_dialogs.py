...
SCENARIOS: List[Dict] = [
    ...
    },
    {
        ...
        "title": "Проверка погоды перед записью",
        "messages": [
            "Привет! Перед визитом хочется знать погоду в Пуэрто-де-Сагунто.",
            "Если днём жара, то давай в более прохладное время.",
            "А после стрижки посоветуешь укладку, чтобы держалась на жаре?"
        ],
    },
    {
        "id": "spanish_switch",
